...
% Opening
\title{Project Tender: \\ Arcane Arcade }
...
\begin{titlepage}
    ...
    \line(1,0){300}
	\\[0.2cm]
    {\scshape\large  Arcane Arcade \par}
	\vspace{0.1cm}
	\line(1,0){300}
	\\[0.05cm]
...
\begin{center}
	...
	\end{center}
		\begin{itemize}
\item I recently worked in a project at the university which introduced me to some extensive software development, which included working in teams, and working on different stages of software development (gathering and documenting requirements, designing, testing and so on).
...
<<<<<<< HEAD:Proposals/ArdaneArcade.tex
...
\item Using Maven Builds for consistency and effective testing
\item Collaborating via Git as a version control system using a Github repository
\item Usage of PHP web for browser and database integration or compiling the HTML pages to be served on the server with C\# or Java
\item Using some structure such as XML which will contain the keywords and map them to their meanings and then just overlay them on the language's skeleton
>>>>>>> 96224bf7268f16231af955096fcce8524d82d678:Proposals/ArcaneArcade.tex
\end{itemize}
\newpage
\vspace*{-3cm}\
\begin{center}
