...
\begin{document}
	...
	\section{Functional Requirements and Application Design}
	   ...
	   \end{itemize}
		...
		\centerline {\includegraphics[width=14cm,height=14cm,keepaspectratio]{Authenticate.jpg}}
		...
		\centerline {\includegraphics[width=14cm,height=14cm,keepaspectratio]{userManagement.jpg}}
		\begin{itemize}
		...
		\centerline {\includegraphics[width=15cm,height=15cm,keepaspectratio]{challengeManagement.jpg}}
		...
		Only super users(management accounts) have access to this module.It provides the ability to add, remove and view levels of a particular challenge.
			...
			\centerline {	\includegraphics[width=14cm,height=14cm,keepaspectratio]{levelManagement.jpg}}
		...
		\centerline {\includegraphics[width=10cm,height=10cm,keepaspectratio]{questionManagement.jpg}}
