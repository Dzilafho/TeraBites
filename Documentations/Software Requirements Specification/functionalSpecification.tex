...
\begin{document}
	...
	\section{Functional Requirements and Application Design}
	   ...
	   \end{itemize}
		...
		\centerline {\includegraphics[width=14cm,height=15cm]{ArcaneArcade.jpg}}
		...
		\centerline {\includegraphics[scale=0.4]{Authenticate.jpg}}
		...
		\centerline {\includegraphics[scale=0.4]{userManagement.jpg}}
		\begin{itemize}
	  		...
	  		\newpage
				...
				\begin{center}
	  			...
	  			\begin{figure}[H]
	  				\begin{center}
	  					 \centerline{\includegraphics[scale=0.4]{AddUserContract.jpg}}
	  				\end{center}
	  			...
	  			\begin{figure}[H]
	  				\begin{center}
	  					 \centerline{\includegraphics[scale=0.4]{addUser1.jpg}}
	  				\end{center}
	  		...
	  		\item \textbf{updateUser} - The updateUser use case falls under User as depicted in the above diagram. The manager has the ability to modify user accounts items via the user management page. The service contract and activity diagram for updateUser are shown below.
	  			...
	  			\begin{figure}[H]
	  				\begin{center}
	  					 \centerline{\includegraphics[scale=0.4]{UpdateUserContract.jpg}}
	  				\end{center}
			...
			\begin{figure}[H]
				\begin{center}
					 \centerline{\includegraphics[scale=0.4]{removeUserlContract.jpg}}
				\end{center}
			...
			\begin{figure}[H]
				\begin{center}
					 \centerline{\includegraphics[scale=0.4]{RemoveUser1.jpg}}
				\end{center}
		...
		\centerline {\includegraphics[scale=0.4]{challengeManagement.jpg}}
		...
		\begin{itemize}
			...
			\begin{figure}[H]
				\begin{center}
					 \centerline{\includegraphics[scale=0.4]{AddChallengeContract.jpg}}
				\end{center}
		 ...
		 \item \textbf{removeChallenge} -  The removeChallenge use case falls under Challenge Management module as depicted in the above diagram.  The removeChallenge submodule allows the administrator to remove challenges from the system via the Challenge Management page. The service contract and activity diagram for removeChallenge are shown below.
			\newpage
		 	...
		 	\begin{figure}[H]
		 		\begin{center}
		 			 \centerline{\includegraphics[scale=0.4]{removeChallengeContract.jpg}}
		 		\end{center}
		 	...
		 	\end{figure}
		 	 ...
		 	 \begin{figure}[H]
		 	 	\begin{center}
		 	 		 \centerline{\includegraphics[scale=0.4]{viewChallengesContract.jpg}}
		 	 	\end{center}
		 	 ...
		 	 \newpage
		 	 	...
		 	 	\begin{figure}[H]
		 	 		\begin{center}
		 	 			 \centerline{\includegraphics[scale=0.4]{ViewChallenges.jpg}}
		 	 		\end{center}
		...
		Only super users(management accounts) have access to this module.It provides the ability to add, remove and view levels of a particular challenge.
			...
			\centerline {	\includegraphics[scale=0.4]{levelManagement.jpg}}
	    ...
	    \begin{figure}[H]
	    	\begin{center}
	    		 \centerline{\includegraphics[scale=0.4]{AddLevelContract.jpg}}
	    	\end{center}
	    ...
	    \item \textbf{removeLevel} -  The removeLevel use case falls under Level Management module as depicted in the above diagram.  The removeLevel submodule allows the administrator to remove levels from challenges on the system via the level Management page. The service contract and activity diagram for addLevel are shown below.	
	     ...
	     \begin{figure}[H]
	     	\begin{center}
	     		 \centerline{\includegraphics[scale=0.4]{removeLevelContract.jpg}}
	     	\end{center}
 	    ...
 	    \item \textbf{viewLevels} -  The viewLevels use case falls under Level Management module as depicted in the above diagram.  The viewLevels submodule allows the administrator to view all the levels from challenge on the system via the level Management page. The service contract and activity diagram for viewLevels are shown below.	
 	     ...
 	     \begin{figure}[H]
 	     	\begin{center}
 	     		\centerline {\includegraphics[scale=0.4]{ViewLevelsContract.jpg}}
 	     	\end{center}
		...
		\centerline {\includegraphics[scale=0.4]{questionManagement.jpg}}
			...
			\begin{itemize}
		  		...
		  		\begin{figure}[H]
		  			\begin{center}
		  			 ...
		  			 \centerline{\includegraphics[scale=0.4]{addQuestionContract.jpg}}
		  			\end{center}
		  			\caption{View all levels on a challenge}
	  		...
	  		\item \textbf{removeQuestions} -  The manager has the ability to remove Questions though the management portal. This questions belong to levels which in turn belong to challenges. The service contract and activity diagram for removeQuestion are shown below.
	  			...
	  			\begin{figure}[H]
	  				\begin{center}
	  					 ...
	  					 \centerline{\includegraphics[scale=0.4]{removeQuestion.jpg}}
	  				\end{center}
	  				\caption{View all levels on a challenge}
			...
			\item \textbf{viewQuestions} - The viewQuestions use case provides the manager the ability to get a list of all Questions from all Levels on the system. The service contract and activity diagram for viewQuestions are as follows.
				...
				\begin{figure}[H]
					\begin{center}
						 \centerline{\includegraphics[scale=0.4]{viewQuestionsContract.jpg}}
					\end{center}
					\caption{View all levels on a challenge}
		...
		This module is the backbone of the system. It is responsible for everything that has to do with the user's code. It compiles, executes and displays output that has been generated by the user code.
			...
			\begin{figure}[H]
				\begin{center}
					 \centerline{\includegraphics[scale=0.4]{Compile.jpg}}
				\end{center}
				\caption{The use case diagram for Compiler Module}
				
			\end{figure}
			\begin{figure}[H]
					\begin{center}
						 \centerline{\includegraphics[scale=0.4]{CompileModule.jpg}}
					\end{center}
					\caption{The service contract diagram for Compiler Module}
		...
		This module houses the system's main functionality. The main reason of having the system is to allow the users to interact with the system and complete the offered challenges. This use case diagram indicates the functionality around interacting with the system as a player.
			...
			\begin{figure}[H]
				\begin{center}
					 \centerline{\includegraphics[scale=0.4]{Player.jpg}}
				\end{center}
				\caption{The use case diagram for Player Interaction Module}
				
			\end{figure}
				\begin{figure}[H]
					\begin{center}
						 \centerline{\includegraphics[scale=0.4]{PlayerInteraction1.jpg}}
					\end{center}
					\caption{The service contract diagram for Player Interaction Module}
		...
		\section{Domain Model}
		 \centerline { \includegraphics[width=15cm,height=15cm,keepaspectratio]{domainModel v2.png}}
	\iffalse	
