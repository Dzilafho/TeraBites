	...
	\section{Architecture Requirements}
		...
		\subsection{Quality requirements}
			...
			\begin{list}{$\bullet$}{\leftmargin=1.5cm \itemindent=0em}
				...
				Authentification will be achieved via the Authentification module of the website. Players 					need to log in with a valid username before they can use any functionality of the website.
